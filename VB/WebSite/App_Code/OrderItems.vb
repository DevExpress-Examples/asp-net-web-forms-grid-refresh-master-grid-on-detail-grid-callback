...
'INSTANT VB NOTE: The field owner was renamed since Visual Basic does not allow fields to have the same name as other class members:
	Private owner_Conflict As IList

	Public Sub New(ByVal owner As IList)
		Me.owner_Conflict = owner
	End Sub
...
'INSTANT VB NOTE: The field name was renamed since Visual Basic does not allow fields to have the same name as other class members:
	Private name_Conflict As String = String.Empty
'INSTANT VB NOTE: The field price was renamed since Visual Basic does not allow fields to have the same name as other class members:
	Private price_Conflict As Decimal = 0
	Public Sub New(ByVal owner As IList)
		MyBase.New(owner)
	End Sub
...
'INSTANT VB NOTE: The field productId was renamed since Visual Basic does not allow fields to have the same name as other class members:
	Private productId_Conflict As Integer
...
'INSTANT VB NOTE: The field product was renamed since Visual Basic does not allow fields to have the same name as other class members:
	...
	Public Property ProductId() As Integer
		Get
			Return productId_Conflict
		End Get
		Set(ByVal value As Integer)
			productId_Conflict = value
			SetProduct()
		End Set
	End Property
